...
; Generated by EoEquis on 1/13/2024 (UTC)
;
[Setup]
AppID={{2e521343-57d8-4870-b3d5-474e730be79f}
AppName=ASCOM TSO Dome Dome Driver
AppVerName=ASCOM TSO Dome Dome Driver 2.0.0.0
AppVersion=2.0.0.0
...
OutputDir="."
OutputBaseFilename="TSO Dome Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\TSO Dome"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\TSO Dome"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "G:\Dev\Git\TriStar Observatory ASCOM Dome V2\bin\Release\ASCOM.TSO.Dome.exe"; DestDir: "{app}"
; TODO: Add driver assemblies into the ServedClasses folder
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "G:\Dev\Git\TriStar Observatory ASCOM Dome V2\README.TXT"; DestDir: "{app}"; Flags: isreadme
; TODO: Add other files needed by your driver here (add subfolders above)
Source: "G:\Dev\Git\TriStar Observatory ASCOM Dome V2\bin\Release\Newtonsoft.Json.dll"; DestDir: "{app}"
Source: "G:\Dev\Git\TriStar Observatory ASCOM Dome V2\bin\Release\Newtonsoft.Json.xml"; DestDir: "{app}"
...
Filename: "{app}\ASCOM.TSO.Dome.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.TSO.Dome.exe"; Parameters: "/unregister"
