...
namespace ASCOM.TSO.Dome
{
    ...
    //
    // Your driver's DeviceID is ASCOM.TSO.Dome
    //
    // The COM Guid attribute sets the CLSID for ASCOM.TSO.Dome
    ...
    public class Dome : ReferenceCountedObjectBase, IDomeV2, IDisposable
    {
        ...
        public Dome()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.TSO.Dome", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
